...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf() {
        ...
        LibraryUser user1 = new LibraryUser("Rafał", "Janus", "1234567");
        LibraryUser user2 = new LibraryUser("Piotr", "Kowalski", "7654321");
        LibraryUser user3 = new LibraryUser("Jan", "Nowak", "1234567");
        ...
        List<Book> zeroBooks = bookLibrary.listBooksInHandsOf(user1);
        List<Book> oneBook = bookLibrary.listBooksInHandsOf(user2);
        List<Book> fiveBooks = bookLibrary.listBooksInHandsOf(user3);
